...
class TestCrawler(unittest.TestCase):
    ...
    def test_file_download(self):
        ...
        self.assertTrue(os.path.isfile(downloader.directory+"py.png"))
        self.assertTrue(os.path.isfile(downloader.directory+"logo.png"))
        self.assertTrue(os.path.isfile(downloader.directory+"py(0).png"))
        self.assertTrue(os.path.isfile(downloader.directory+"py(1).png"))
        self.assertTrue(os.path.isfile(downloader.directory+"py(2).png"))
        self.assertTrue(os.path.isfile(downloader.directory+"logo(3).png"))
